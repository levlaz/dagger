...
```go file=./snippets/copy-filter-dir/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./snippets/copy-filter-dir/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./snippets/copy-filter-dir/typescript/index.ts
```
...
```go file=./snippets/builds/oci/go/main.go
```

</TabItem>
<TabItem value="Python">

```python file=./snippets/builds/oci/python/main.py
```

</TabItem>
<TabItem value="TypeScript">

```typescript file=./snippets/builds/oci/typescript/index.ts
```
...
The following function demonstrates how to invalidate the Dagger layer cache and force execution of subsequent pipeline steps, by
...
```typescript file=./snippets/continue-after-errors/typescript/index.ts
```
